*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_PICKSTTYPE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_PICKSTTYPE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_PICKSTTYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_PICKSTTYPE_EXTRACT
TOTAL = ZMV_PICKSTTYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_PICKSTTYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_PICKSTTYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PICKSTTYPE_EXTRACT
TOTAL = ZMV_PICKSTTYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_PICKSTTYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_PICKSTTYPE'
...
TOTAL = ZMV_PICKSTTYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_PICKSTTYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_PICKSTTYPE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_PICKSTTYPE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_PICKSTTYPE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PICKSTTYPE_EXTRACT
TOTAL = ZMV_PICKSTTYPE_TOTAL
