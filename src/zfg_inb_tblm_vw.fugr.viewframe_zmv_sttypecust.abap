*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_STTYPECUST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_STTYPECUST      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_STTYPECUST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_STTYPECUST_EXTRACT
TOTAL = ZMV_STTYPECUST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_STTYPECUST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_STTYPECUST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_STTYPECUST_EXTRACT
TOTAL = ZMV_STTYPECUST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_STTYPECUST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_STTYPECUST'
...
TOTAL = ZMV_STTYPECUST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_STTYPECUST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_STTYPECUST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_STTYPECUST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_STTYPECUST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_STTYPECUST_EXTRACT
TOTAL = ZMV_STTYPECUST_TOTAL
