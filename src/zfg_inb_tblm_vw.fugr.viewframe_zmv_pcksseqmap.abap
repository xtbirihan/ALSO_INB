*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_PCKSSEQMAP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_PCKSSEQMAP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_PCKSSEQMAP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_PCKSSEQMAP_EXTRACT
TOTAL = ZMV_PCKSSEQMAP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_PCKSSEQMAP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_PCKSSEQMAP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PCKSSEQMAP_EXTRACT
TOTAL = ZMV_PCKSSEQMAP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_PCKSSEQMAP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_PCKSSEQMAP'
...
TOTAL = ZMV_PCKSSEQMAP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_PCKSSEQMAP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_PCKSSEQMAP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_PCKSSEQMAP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_PCKSSEQMAP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PCKSSEQMAP_EXTRACT
TOTAL = ZMV_PCKSSEQMAP_TOTAL
