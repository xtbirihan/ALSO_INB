*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WLOCMIMO
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WLOCMIMO        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WLOCMIMO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WLOCMIMO_EXTRACT
TOTAL = ZMV_WLOCMIMO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WLOCMIMO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WLOCMIMO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WLOCMIMO_EXTRACT
TOTAL = ZMV_WLOCMIMO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WLOCMIMO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WLOCMIMO'
...
TOTAL = ZMV_WLOCMIMO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WLOCMIMO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WLOCMIMO-UPD_FLAG NE SPACE.
