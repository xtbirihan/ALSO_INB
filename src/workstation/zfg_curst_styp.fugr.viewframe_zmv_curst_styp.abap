*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_CURST_STYP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_CURST_STYP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_CURST_STYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_CURST_STYP_EXTRACT
TOTAL = ZMV_CURST_STYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_CURST_STYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_CURST_STYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_CURST_STYP_EXTRACT
TOTAL = ZMV_CURST_STYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_CURST_STYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_CURST_STYP'
...
TOTAL = ZMV_CURST_STYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_CURST_STYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_CURST_STYP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_CURST_STYP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_CURST_STYP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_CURST_STYP_EXTRACT
TOTAL = ZMV_CURST_STYP_TOTAL
