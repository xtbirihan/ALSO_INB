*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_CART_BCODE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_CART_BCODE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_CART_BCODE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_CART_BCODE_EXTRACT
TOTAL = ZMV_CART_BCODE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_CART_BCODE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_CART_BCODE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_CART_BCODE_EXTRACT
TOTAL = ZMV_CART_BCODE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_CART_BCODE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_CART_BCODE'
...
TOTAL = ZMV_CART_BCODE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_CART_BCODE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_CART_BCODE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_CART_BCODE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_CART_BCODE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_CART_BCODE_EXTRACT
TOTAL = ZMV_CART_BCODE_TOTAL
